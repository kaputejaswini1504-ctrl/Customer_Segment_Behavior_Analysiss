...
SELECT gender, ROUND(SUM(purchase_amount_usd::numeric),2) AS revenue
FROM customer
GROUP BY gender;
...
ROUND(AVG(purchase_amount_usd::numeric),2)
from customer
...
CASE
    ...
    ELSE 'Senior'
END AS age_group,
ROUND(SUM(purchase_amount_usd::numeric),0) AS total_revenue
FROM customer
GROUP BY age_group
